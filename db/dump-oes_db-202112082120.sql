...
CREATE TABLE `permissions` (
  ...
  `permissionsName` varchar(100) DEFAULT NULL,
...
CREATE TABLE `user` (
  ...
  `phone` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '账号（手机号）',
...
-- Dump completed on 2021-12-08 21:20:15
